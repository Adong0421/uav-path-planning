...
def calculate_drone_converage_width(fov_angle, altitude, ground_resolution):
...
if __name__ == '__main__':
    ...
    drone_width = calculate_drone_converage_width(fov_angle, altitude, ground_resolution)
